...
class SlickExampleScheduler @Inject()(lmsService: LMSService, system: ActorSystem, materializer: ActorMaterializer, loginTable: LoginTable,
                                      configTable: ConfigTable, configuration: Configuration)(implicit ec: ExecutionContext) {
